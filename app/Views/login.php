    ...
    <div class="card-body p-4">
        <form action="<?= base_url('login') ?>" method="post">
            <div class="mb-3">
                ...
                <input type="email" class="form-control border-primary" id="email" name="email" required value="<?= esc(old('email')) ?>">
            </div>
            <div class="mb-3">
...
<p class="text-center mt-3 small">
    Don't have an account? <a href="<?= base_url('register') ?>" class="text-primary fw-bold">Register</a>
</p>
    </div>
</div>
<?= $this->endSection() ?>
